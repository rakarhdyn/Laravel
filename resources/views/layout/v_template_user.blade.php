...
<head>
    ...
    <!-- Stylesheets-->
    <link rel="stylesheet" type="{{asset('css_rave/text/css')}}" href="//fonts.googleapis.com/css?family=Montserrat:400,500,600,700%7CPoppins:400%7CTeko:300,400">
    <link rel="stylesheet" href="{{asset('css_rave/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{asset('css_rave/css/fonts.css')}}">
    <link rel="stylesheet" href="{{asset('css_rave/css/style.css')}}">
    <style>
        .ie-panel {
            display: none;
            background: #212121;
                        ...
                        <div class="rd-navbar-main">
                            <div class="rd-navbar-nav-wrap">
                                ...
                                <ul class="rd-navbar-nav">
                                    <li class="rd-nav-item"><a class="brand" href="index.html"><img src="images/logo.png" alt="" width="50" height="50" /></a>
                                    </li>
                                    <li class="rd-nav-item active"><a class="rd-nav-link" href="index.html">Home</a>
                                    </li>
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="destination.html">Destination</a>
                                    </li>
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="paket.html">Packages</a>
                                    </li>
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="galeri.html">Gallery</a>
                                    </li>
